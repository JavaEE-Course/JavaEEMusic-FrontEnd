    ...
    <div class="container">
      ...
      <el-table ref="multipleTable" size="mini" border style="width: 100%" height="520px"
        ...
        <el-table-column label="歌手图片" width="110" align="center">
          <template slot-scope="scope">
            <div class="singer-img">
              <img :src= "scope.row.url"  alt="" style="width: 100%;"/>
            </div>
          </template>
        </el-table-column>
        <el-table-column prop="name" label="歌手" width="120" align="center"></el-table-column>
        <el-table-column label="性别" prop="type" width="50" align="center"></el-table-column>
        ...
        <el-table-column label="专辑管理" width="110" align="center">
          <template slot-scope="scope">
            <el-button size="mini" @click="albumEdit(scope.row.id)">专辑管理</el-button>
          </template>
        </el-table-column>
