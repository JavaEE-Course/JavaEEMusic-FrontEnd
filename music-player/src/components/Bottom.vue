...
<!--      &lt;!&ndash; <audio :src="globalMusicUrl" autoplay controls ref="audio" @timeupdate="updateTime" @pause="pauseStatus" @play="playStatus"></audio> &ndash;&gt;-->
...
//   data () {
//     return {
//       defaultImg: require('@/assets/1.jpg'),
//       musicUrl: '',
//       currentTime: 0
//     }
//   },
...
//   methods: {
//     toSongDetail () {
//       if (this.globalMusicUrl) { this.$parent.show = !this.$parent.show } else {
//         this.$message({
//           showClose: true,
//           message: '还没有播放音乐哦',
//           type: 'error'
